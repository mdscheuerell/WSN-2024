...
## .blue.center[From this we can show that]
...
## .blue.center[So given this]

$$\LARGE \text{Var}(x_t) = \frac{\text{Var}(w_t)}{1 - b^2}$$

## .center[We can expect that a .blue[population] is .blue[less stable]]

## .center[when the .green[environment] is .green[more variable] or as]

## .center[the strength of .orange[density-dependence decreases]]
...
### .blue.center[ We can also define this cube with 3 vectors for the cube's vertices ]
