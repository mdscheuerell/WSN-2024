...
# Going from time series of abundance
...
text("-0.5", x = xm[2] * 0.95, y = y0 - (y0 - y1) / 2, pos = 2,
     cex = 2, col = "#80cdc1")
text("0.6", x = xm[2] * 0.65, y = ymt,
     cex = 2, col = "#80cdc1")
## arrows
arrows(x0 = xm[2] * 0.95, y0 = y0, y1 = y1,
       col = "#80cdc1", lwd = 3, length = 0.12)
## circle
symbols(x = xm[2] * 0.65, y = ymt, circles = c(2),
...
### .blue.center[It turns out that]

$$\LARGE \text{Var}(x_t) = \frac{\text{Var}(w_t)}{1 - b^2}$$

### .blue.center[which gets larger as _b_ gets larger]
